...
![003](../images/pipeline/image003.png)

3. 로그인 한 후 카탈로그 페이지로 이동한다.
![004](../images/pipeline/image004.png)
...
![006](../images/pipeline/image006.png)

3. 서비스 이름을 입력한다. 이미 신청한 배포 파이프라인의 이름이 있을 경우 아래 첨부 사진과 같이 에러가 출력된다.
![007](../images/pipeline/image007.png)
...
2. 배포 파이프라인 접속을 확인한다.
![010](../images/pipeline/image010.png)
...
![021](../images/pipeline/image021.png)
...
2. 파이프라인 신규 생성 페이지로 이동한다.
![032](../images/pipeline/image032.png)
...
![036](../images/pipeline/image036.png)
...
![039](../images/pipeline/image039.png)

2.	수정하고 나면 파이프라인 상세 페이지로 이동한다. 다시 “정보보기/수정” 버튼을 클릭하여 변경된 값을 확인한다.
![040](../images/pipeline/image040.png)
...
![042](../images/pipeline/image042.png)
...
![048](../images/pipeline/image048.png)
...
![050](../images/pipeline/image050.png)
...
![055](../images/pipeline/image055.png)
...
2.	구성 상세페이지로 이동한다.
![057](../images/pipeline/image057.png)
...
![058](../images/pipeline/image058.png)
...
![065](../images/pipeline/image065.png)
3. 실행이 완료되면 초록색으로 바뀌며 작업 부분에 Build(실행완료) 로 표시된다.
![066](../images/pipeline/image066.png)
...
![068](../images/pipeline/image068.png)
...
![070](../images/pipeline/image070.png)
3.	빌드 Job 실행이 완료된 것을 확인하고, 히스토리를 확인한다.
![071](../images/pipeline/image071.png)
...
![083](../images/pipeline/image083.png)
...
![085](../images/pipeline/image085.png)
...
4.	구성 상세페이지로 이동하여 수정된 정보들을 확인한다.
![089](../images/pipeline/image089.png)
...
2.	실행이 될 때 파란색으로 바뀌며 깜빡이는 것을 확인할 수 있다. (실행 중에 “로그/히스토리” 아이콘을 클릭하여 실시간으로 로그를 조회할 수 있다.)
![091](../images/pipeline/image091.png)
...
2.	정지된 빌드 Job은 주황색으로 바뀌는 것을 확인할 수 있다
![093](../images/pipeline/image093.png)
...
2.	로그 조회 페이지로 이동한다. 실시간으로 로그가 보이고 있는 것을 확인한다.
![095](../images/pipeline/image095.png)
3.	테스트 Job 실행이 완료된 것을 확인하고, 히스토리를 확인한다.
![096](../images/pipeline/image096.png)
...
![097](../images/pipeline/image097.png)
...
![100](../images/pipeline/image100.png)
...
![102](../images/pipeline/image102.png)
...
2.	실행이 될 때 파란색으로 바뀌며 깜빡이는 것을 확인할 수 있다. (실행 중에 “로그/히스토리” 아이콘을 클릭하여 실시간으로 로그를 조회할 수 있다.)
![109](../images/pipeline/image109.png)
3. 실행이 완료되면 초록색으로 바뀌며 작업 부분에 Deploy(실행완료) 로 표시된다.
![110](../images/pipeline/image110.png)
...
![112](../images/pipeline/image112.png)
...
2.	로그 조회 페이지로 이동한다. 실시간으로 로그가 보이고 있는 것을 확인한다.
![114](../images/pipeline/image114.png)
3.	배포 Job 실행이 완료된 것을 확인하고, 히스토리를 확인한다.
![115](../images/pipeline/image115.png)
...
3.	롤백을 진행한다.
![119](../images/pipeline/image119.png)
...
![123](../images/pipeline/image123.png)
...
![125](../images/pipeline/image125.png)
...
![128](../images/pipeline/image128.png)
...
![130](../images/pipeline/image130.png)
...
![133](../images/pipeline/image133.png)
...
![140](../images/pipeline/image140.png)
...
![142](../images/pipeline/image142.png)
2.	“규칙상세” 버튼을 클릭한다.
![143](../images/pipeline/image143.png)
...
![144](../images/pipeline/image144.png)
...
![149](../images/pipeline/image149.png)
...
![159](../images/pipeline/image159.png)
...
![176](../images/pipeline/image176.png)
