...
>  
![](../images/applifecycle-service/image002.png)

## <div id="3.3"/>  3.3. PaaS-TA 사용자 포탈 - 서비스 신청
-	PaaS-TA 사용자  포탈에 접속하여, 카탈로그를 통해 서비스를 신청한다.   

![](../images/applifecycle-service/image003.png)

-	대시보드 URL을 통해 서비스에 접근한다.  (서비스의 관리자 계정은 serviceadmin/[서비스 신청시 입력받은 패스워드])  

![](../images/applifecycle-service/image004.png)

 > 라이프사이클 관리 서비스 대시보드
 >
 > ![](../images/applifecycle-service/image005.png)
 >  
 > ![](../images/applifecycle-service/image006.png)
