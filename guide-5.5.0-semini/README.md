...
- 단독 배포
  - [단독 배포 설치](/test-5-5-0/guide-5.5.0-semini/install-guide/container-platform-standalone/paas-ta-container-platform-standalone-deployment-guide-v1.0.md)
...
- CaaS 서비스 배포
  - [단독 배포 설치](/test-5-5-0/guide-5.5.0-semini/install-guide/container-platform-standalone/paas-ta-container-platform-standalone-deployment-guide-1-v1.0.md)
